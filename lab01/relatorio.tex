...
Os protótipos são as médias por classe do conjunto de treino, exatamente como na Eq.~\eqref{eq:prototipo}. O programa principal calcula dois conjuntos: \texttt{means\_4d}, com os quatro atributos, usado nos classificadores (i) e (ii); e \texttt{means\_2d}, com os dois primeiros, usado nas retas do item (iii). A função \texttt{dist\_euclidiana} implementa a Eq.~\eqref{eq:distancia}, e \texttt{classificar} atribui cada amostra à classe de menor distância:
